...
from ...schedulers import KarrasDiffusionSchedulers, DDIMScheduler
from ...utils import (
    PIL_INTERPOLATION,
    deprecate,
...
class StableDiffusionLDM3DImg2ImgPipeline(DiffusionPipeline, TextualInversionLoaderMixin, LoraLoaderMixin, FromCkptMixin):
    r"""
    ...
    def run_safety_checker(self, image, device, dtype):
        if self.safety_checker is None:
            ...
            if isinstance(feature_extractor_input, tuple):
                for fei in feature_extractor_input:
                    safety_checker_input = self.feature_extractor(fei, return_tensors="pt").to(device)
